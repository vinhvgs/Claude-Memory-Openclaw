            ...
            >
              ...
              {formState.CLAUDE_MEM_PROVIDER === 'openrouter' && (
                <>
                  ...
                  <FormField
                    label="Site URL / API Base (Optional)"
                    tooltip="Site URL for OpenRouter analytics, or an OpenRouter-compatible API base like https://your-router.example/v1"
                  >
                    <input
                      type="text"
                      value={formState.CLAUDE_MEM_OPENROUTER_SITE_URL || ''}
                      onChange={(e) => updateSetting('CLAUDE_MEM_OPENROUTER_SITE_URL', e.target.value)}
                      placeholder="https://yoursite.com or https://router.example/v1"
                    />
                  </FormField>
                  <FormField
