...
- **[Ferramentas de Busca](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/search-tools.mdx)** - Consulte seu histórico de projeto com linguagem natural
...
- **[Banco de Dados](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/database.mdx)** - Schema SQLite e busca FTS5
- **[Arquitetura de Busca](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/search-architecture.mdx)** - Busca híbrida com banco de dados vetorial Chroma
...
Veja [Guia de Ferramentas de Busca](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/search-tools.mdx) para exemplos detalhados.
