...
📚 **[عرض التوثيق الكامل](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public)** - تصفح على الموقع الرسمي

### البدء

- **[دليل التثبيت](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/installation.mdx)** - البدء السريع والتثبيت المتقدم
- **[دليل الاستخدام](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/getting-started.mdx)** - كيف يعمل Claude-Mem تلقائيًا
- **[أدوات البحث](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/search-tools.mdx)** - استعلم عن سجل مشروعك بلغتك
- **[الميزات التجريبية](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/beta-features.mdx)** - جرّب الميزات التجريبية مثل Endless Mode

### أفضل الممارسات

- **[هندسة السياق](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/context-engineering.mdx)** - مبادئ تحسين سياق وكيل الذكاء الاصطناعي
- **[الكشف التدريجي](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/progressive-disclosure.mdx)** - الفلسفة وراء استراتيجية تهيئة السياق في Claude-Mem

### البنية المعمارية

- **[نظرة عامة](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/overview.mdx)** - مكونات النظام وتدفق البيانات
- **[تطور البنية المعمارية](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture-evolution.mdx)** - تطور المعمارية من v3 إلى v5
- **[بنية برامج الربط (Hooks)](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/hooks-architecture.mdx)** - كيف يستخدم Claude-Mem خطافات دورة الحياة
- **[مرجع برامج الربط (Hooks)](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/hooks.mdx)** - شرح 7 سكريبتات خطافات
- **[خدمة العامل](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/worker-service.mdx)** - HTTP API وإدارة Bun
- **[قاعدة البيانات](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/database.mdx)** - مخطط SQLite وبحث FTS5
- **[بنية البحث](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/search-architecture.mdx)** - البحث المختلط مع قاعدة بيانات المتجهات Chroma

### الإعدادات والتطوير

- **[الإعدادات](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/configuration.mdx)** - متغيرات البيئة والإعدادات
- **[التطوير](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx)** - البناء، الاختبار، سير العمل للمساهمة
- **[استكشاف الأخطاء وإصلاحها](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/troubleshooting.mdx)** - المشكلات الشائعة والحلول
...
انظر [نظرة عامة على البنية المعمارية](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/overview.mdx) للتفاصيل.
...
انظر [دليل أدوات البحث](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/search-tools.mdx) لأمثلة مفصلة.
...
انظر **[توثيق الميزات التجريبية](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/beta-features.mdx)** لتفاصيل حول Endless Mode وكيفية تجربته.
...
انظر **[دليل الإعدادات](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/configuration.mdx)** لجميع الإعدادات المتاحة والأمثلة.

---

## التطوير

انظر **[دليل التطوير](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx)** لتعليمات البناء، الاختبار، وسير عمل المساهمة.
...
انظر **[دليل استكشاف الأخطاء وإصلاحها](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/troubleshooting.mdx)** للمشكلات الشائعة والحلول.
...
انظر [دليل التطوير](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx) لسير عمل المساهمة.
...
- **التوثيق**: [docs/](docs/)
- **المشكلات**: [GitHub Issues](https://github.com/vinhvgs/Claude-Memory-Openclaw/issues)
- **المستودع**: [github.com/vinhvgs/Claude-Memory-Openclaw](https://github.com/vinhvgs/Claude-Memory-Openclaw)
- **المؤلف**: Alex Newman (upstream creator)
