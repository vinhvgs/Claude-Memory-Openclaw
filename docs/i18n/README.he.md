...
📚 **[צפה בתיעוד המלא](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public)** - דפדף באתר הרשמי

### תחילת העבודה

- **[מדריך התקנה](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/installation.mdx)** - התחלה מהירה והתקנה מתקדמת
- **[מדריך שימוש](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/getting-started.mdx)** - איך Claude-Mem עובד אוטומטית
- **[כלי חיפוש](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/search-tools.mdx)** - שאל את היסטוריית הפרויקט שלך בשפה טבעית
- **[תכונות בטא](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/beta-features.mdx)** - נסה תכונות ניסיוניות כמו Endless Mode

### שיטות מומלצות

- **[הנדסת הקשר](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/context-engineering.mdx)** - עקרונות אופטימיזציה של הקשר לסוכן AI
- **[גילוי מדורג](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/progressive-disclosure.mdx)** - הפילוסופיה מאחורי אסטרטגיית הכנת ההקשר של Claude-Mem

### ארכיטקטורה

- **[סקירה כללית](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/overview.mdx)** - רכיבי המערכת וזרימת הנתונים
- **[התפתחות הארכיטקטורה](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture-evolution.mdx)** - המסע מגרסה 3 לגרסה 5
- **[ארכיטקטורת Hooks](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/hooks-architecture.mdx)** - איך Claude-Mem משתמש ב-lifecycle hooks
- **[מדריך Hooks](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/hooks.mdx)** - 7 סקריפטי hook מוסברים
- **[שירות Worker](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/worker-service.mdx)** - HTTP API וניהול Bun
- **[מסד נתונים](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/database.mdx)** - סכמת SQLite וחיפוש FTS5
- **[ארכיטקטורת חיפוש](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/search-architecture.mdx)** - חיפוש היברידי עם מסד נתוני וקטורים Chroma

### הגדרות ופיתוח

- **[הגדרות](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/configuration.mdx)** - משתני סביבה והגדרות
- **[פיתוח](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx)** - בנייה, בדיקה, תרומה
- **[פתרון בעיות](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/troubleshooting.mdx)** - בעיות נפוצות ופתרונות
...
ראה [סקירה כללית של הארכיטקטורה](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/overview.mdx) לפרטים.
...
ראה [מדריך כלי חיפוש](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/search-tools.mdx) לדוגמאות מפורטות.
...
ראה **[תיעוד תכונות בטא](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/beta-features.mdx)** לפרטים על Endless Mode ואיך לנסות אותו.
...
ראה **[מדריך הגדרות](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/configuration.mdx)** לכל ההגדרות הזמינות ודוגמאות.

---

## פיתוח

ראה **[מדריך פיתוח](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx)** להוראות בנייה, בדיקה, ותהליך תרומה.
...
ראה **[מדריך פתרון בעיות](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/troubleshooting.mdx)** לבעיות נפוצות ופתרונות.
...
ראה [מדריך פיתוח](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx) לתהליך תרומה.
...
- **תיעוד**: [docs/](docs/)
- **בעיות**: [GitHub Issues](https://github.com/vinhvgs/Claude-Memory-Openclaw/issues)
- **מאגר**: [github.com/vinhvgs/Claude-Memory-Openclaw](https://github.com/vinhvgs/Claude-Memory-Openclaw)
- **מחבר**: Alex Newman (upstream creator)
