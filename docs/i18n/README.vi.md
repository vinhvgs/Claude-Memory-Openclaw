...
📚 **[Xem Tài Liệu Đầy Đủ](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public)** - Duyệt trên trang web chính thức

### Bắt Đầu

- **[Hướng Dẫn Cài Đặt](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/installation.mdx)** - Bắt đầu nhanh & cài đặt nâng cao
- **[Hướng Dẫn Sử Dụng](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/getting-started.mdx)** - Cách Claude-Mem hoạt động tự động
- **[Công Cụ Tìm Kiếm](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/search-tools.mdx)** - Truy vấn lịch sử dự án bằng ngôn ngữ tự nhiên
- **[Tính Năng Beta](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/beta-features.mdx)** - Dùng thử các tính năng thử nghiệm như Endless Mode

### Thực Hành Tốt Nhất

- **[Kỹ Thuật Ngữ Cảnh](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/context-engineering.mdx)** - Các nguyên tắc tối ưu hóa ngữ cảnh cho AI agent
- **[Tiết Lộ Tuần Tự](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/progressive-disclosure.mdx)** - Triết lý đằng sau chiến lược chuẩn bị ngữ cảnh của Claude-Mem

### Kiến Trúc

- **[Tổng Quan](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/overview.mdx)** - Các thành phần hệ thống & luồng dữ liệu
- **[Phát Triển Kiến Trúc](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture-evolution.mdx)** - Hành trình từ v3 đến v5
- **[Kiến Trúc Hooks](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/hooks-architecture.mdx)** - Cách Claude-Mem sử dụng lifecycle hooks
- **[Tham Chiếu Hooks](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/hooks.mdx)** - Giải thích 7 hook scripts
- **[Worker Service](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/worker-service.mdx)** - HTTP API & quản lý Bun
- **[Cơ Sở Dữ Liệu](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/database.mdx)** - Schema SQLite & tìm kiếm FTS5
- **[Kiến Trúc Tìm Kiếm](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/search-architecture.mdx)** - Tìm kiếm kết hợp với cơ sở dữ liệu vector Chroma

### Cấu Hình & Phát Triển

- **[Cấu Hình](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/configuration.mdx)** - Biến môi trường & cài đặt
- **[Phát Triển](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx)** - Xây dựng, kiểm thử, đóng góp
- **[Khắc Phục Sự Cố](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/troubleshooting.mdx)** - Các vấn đề thường gặp & giải pháp
...
Xem [Tổng Quan Kiến Trúc](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/overview.mdx) để biết chi tiết.
...
Xem [Hướng Dẫn Công Cụ Tìm Kiếm](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/search-tools.mdx) để biết các ví dụ chi tiết.
...
Xem **[Tài Liệu Tính Năng Beta](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/beta-features.mdx)** để biết chi tiết về Endless Mode và cách dùng thử.
...
Xem **[Hướng Dẫn Cấu Hình](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/configuration.mdx)** để biết tất cả các cài đặt và ví dụ có sẵn.

---

## Phát Triển

Xem **[Hướng Dẫn Phát Triển](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx)** để biết hướng dẫn xây dựng, kiểm thử và quy trình đóng góp.
...
Xem **[Hướng Dẫn Khắc Phục Sự Cố](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/troubleshooting.mdx)** để biết các vấn đề thường gặp và giải pháp.
...
Xem [Hướng Dẫn Phát Triển](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx) để biết quy trình đóng góp.
...
- **Tài Liệu**: [docs/](docs/)
- **Vấn Đề**: [GitHub Issues](https://github.com/vinhvgs/Claude-Memory-Openclaw/issues)
- **Repository**: [github.com/vinhvgs/Claude-Memory-Openclaw](https://github.com/vinhvgs/Claude-Memory-Openclaw)
- **Tác Giả**: Alex Newman (upstream creator)
