...
📚 **[Переглянути повну документацію](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public)** - Переглянути на офіційному сайті

### Початок роботи

- **[Посібник з встановлення](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/installation.mdx)** - Швидкий старт і розширене встановлення
- **[Посібник з використання](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/getting-started.mdx)** - Як Claude-Mem працює автоматично
- **[Інструменти пошуку](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/search-tools.mdx)** - Запитуйте історію свого проєкту природною мовою
- **[Бета-функції](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/beta-features.mdx)** - Спробуйте експериментальні функції, як-от режим Endless Mode

### Найкращі практики

- **[Інженерія контексту](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/context-engineering.mdx)** - Принципи оптимізації контексту AI-агента
- **[Прогресивне розкриття](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/progressive-disclosure.mdx)** - Філософія стратегії підготовки контексту Claude-Mem

### Архітектура

- **[Огляд](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/overview.mdx)** - Компоненти системи та потік даних
- **[Еволюція архітектури](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture-evolution.mdx)** - Шлях від v3 до v5
- **[Архітектура хуків](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/hooks-architecture.mdx)** - Як Claude-Mem використовує хуки життєвого циклу
- **[Довідник хуків](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/hooks.mdx)** - Пояснення 7 скриптів хуків
- **[Сервіс воркера](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/worker-service.mdx)** - HTTP API та управління Bun
- **[База даних](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/database.mdx)** - Схема SQLite та пошук FTS5
- **[Архітектура пошуку](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/search-architecture.mdx)** - Гібридний пошук з векторною базою даних Chroma

### Конфігурація та розробка

- **[Конфігурація](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/configuration.mdx)** - Змінні середовища та налаштування
- **[Розробка](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx)** - Збірка, тестування, внесок
- **[Усунення несправностей](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/troubleshooting.mdx)** - Поширені проблеми та рішення
...
Дивіться [Огляд архітектури](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/overview.mdx) для деталей.
...
Дивіться [Посібник з інструментів пошуку](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/search-tools.mdx) для детальних прикладів.
...
Дивіться **[Документацію бета-функцій](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/beta-features.mdx)** для деталей про режим Endless Mode та як його спробувати.
...
Дивіться **[Посібник з конфігурації](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/configuration.mdx)** для всіх доступних налаштувань та прикладів.

---

## Розробка

Дивіться **[Посібник з розробки](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx)** для інструкцій зі збірки, тестування та робочого процесу внеску.
...
Дивіться **[Посібник з усунення несправностей](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/troubleshooting.mdx)** для поширених проблем та рішень.
...
Дивіться [Посібник з розробки](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx) для робочого процесу внеску.
...
- **Проблеми**: [GitHub Issues](https://github.com/vinhvgs/Claude-Memory-Openclaw/issues)
- **Репозиторій**: [github.com/vinhvgs/Claude-Memory-Openclaw](https://github.com/vinhvgs/Claude-Memory-Openclaw)
