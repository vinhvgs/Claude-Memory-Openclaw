...
📚 **[ดูเอกสารฉบับเต็ม](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public)** - เรียกดูบนเว็บไซต์อย่างเป็นทางการ

### เริ่มต้นใช้งาน

- **[คู่มือการติดตั้ง](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/installation.mdx)** - เริ่มต้นอย่างรวดเร็วและการติดตั้งขั้นสูง
- **[คู่มือการใช้งาน](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/getting-started.mdx)** - วิธีที่ Claude-Mem ทำงานโดยอัตโนมัติ
- **[เครื่องมือค้นหา](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/search-tools.mdx)** - สืบค้นประวัติโปรเจกต์ของคุณด้วยภาษาธรรมชาติ
- **[คุณสมบัติ Beta](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/beta-features.mdx)** - ลองคุณสมบัติทดลองเช่น Endless Mode

### แนวปฏิบัติที่ดี

- **[Context Engineering](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/context-engineering.mdx)** - หลักการปรับบริบทสำหรับเอเจนต์ AI
- **[Progressive Disclosure](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/progressive-disclosure.mdx)** - ปรัชญาเบื้องหลังกลยุทธ์การเตรียมบริบทของ Claude-Mem

### สถาปัตยกรรม

- **[ภาพรวม](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/overview.mdx)** - ส่วนประกอบของระบบและการไหลของข้อมูล
- **[วิวัฒนาการของสถาปัตยกรรม](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture-evolution.mdx)** - การเดินทางจาก v3 สู่ v5
- **[สถาปัตยกรรม Hooks](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/hooks-architecture.mdx)** - วิธีที่ Claude-Mem ใช้ lifecycle hooks
- **[การอ้างอิง Hooks](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/hooks.mdx)** - อธิบาย hook scripts ทั้ง 7 ตัว
- **[Worker Service](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/worker-service.mdx)** - HTTP API และการจัดการ Bun
- **[ฐานข้อมูล](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/database.mdx)** - SQLite schema และการค้นหา FTS5
- **[สถาปัตยกรรมการค้นหา](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/search-architecture.mdx)** - การค้นหาแบบไฮบริดด้วยฐานข้อมูลเวกเตอร์ Chroma

### การกำหนดค่าและการพัฒนา

- **[การกำหนดค่า](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/configuration.mdx)** - ตัวแปรสภาพแวดล้อมและการตั้งค่า
- **[การพัฒนา](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx)** - การสร้าง การทดสอบ การมีส่วนร่วม
- **[การแก้ไขปัญหา](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/troubleshooting.mdx)** - ปัญหาและการแก้ไขทั่วไป
...
ดู [ภาพรวมสถาปัตยกรรม](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/overview.mdx) สำหรับรายละเอียด
...
ดู [คู่มือเครื่องมือค้นหา](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/search-tools.mdx) สำหรับตัวอย่างโดยละเอียด
...
ดู **[เอกสารคุณสมบัติ Beta](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/beta-features.mdx)** สำหรับรายละเอียดเกี่ยวกับ Endless Mode และวิธีการลอง
...
ดู **[คู่มือการกำหนดค่า](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/configuration.mdx)** สำหรับการตั้งค่าทั้งหมดที่มีและตัวอย่าง

---

## การพัฒนา

ดู **[คู่มือการพัฒนา](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx)** สำหรับคำแนะนำการสร้าง การทดสอบ และขั้นตอนการมีส่วนร่วม
...
ดู **[คู่มือการแก้ไขปัญหา](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/troubleshooting.mdx)** สำหรับปัญหาและการแก้ไขทั่วไป
...
ดู [คู่มือการพัฒนา](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx) สำหรับขั้นตอนการมีส่วนร่วม
...
- **เอกสาร**: [docs/](docs/)
- **ปัญหา**: [GitHub Issues](https://github.com/vinhvgs/Claude-Memory-Openclaw/issues)
- **Repository**: [github.com/vinhvgs/Claude-Memory-Openclaw](https://github.com/vinhvgs/Claude-Memory-Openclaw)
- **ผู้เขียน**: Alex Newman (upstream creator)
