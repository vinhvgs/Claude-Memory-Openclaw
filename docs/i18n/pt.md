...
📚 **[Ver Documentação Completa](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public)** - Navegar no site oficial

### Começando

- **[Guia de Instalação](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/installation.mdx)** - Início rápido e instalação avançada
- **[Guia de Uso](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/getting-started.mdx)** - Como Claude-Mem funciona automaticamente
- **[Ferramentas de Procura](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/search-tools.mdx)** - Consulte seu histórico de projeto com linguagem natural
- **[Recursos Beta](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/beta-features.mdx)** - Experimente recursos experimentais como o Endless Mode

### Melhores Práticas

- **[Engenharia de Contexto](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/context-engineering.mdx)** - Princípios de otimização de contexto para agentes de IA
- **[Divulgação Progressiva](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/progressive-disclosure.mdx)** - Filosofia por trás da estratégia de preparação de contexto do Claude-Mem

### Arquitetura

- **[Visão Geral](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/overview.mdx)** - Componentes do sistema e fluxo de dados
- **[Evolução da Arquitetura](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture-evolution.mdx)** - A jornada da v3 à v5
- **[Arquitetura de Hooks](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/hooks-architecture.mdx)** - Como Claude-Mem usa hooks de ciclo de vida
- **[Referência de Hooks](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/hooks.mdx)** - 7 scripts de hook explicados
- **[Serviço Worker](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/worker-service.mdx)** - API HTTP e gerenciamento do Bun
- **[Banco de Dados](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/database.mdx)** - Schema SQLite e Procura FTS5
- **[Arquitetura de Procura](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/search-architecture.mdx)** - Procura híbrida com banco de dados vetorial Chroma

### Configuração e Desenvolvimento

- **[Configuração](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/configuration.mdx)** - Variáveis de ambiente e configurações
- **[Desenvolvimento](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx)** - Build, testes e contribuição
- **[Solução de Problemas](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/troubleshooting.mdx)** - Problemas comuns e soluções
...
Veja [Visão Geral da Arquitetura](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/overview.mdx) para detalhes.
...
Veja [Guia de Ferramentas de Procura](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/search-tools.mdx) para exemplos detalhados.
...
Veja **[Documentação de Recursos Beta](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/beta-features.mdx)** para detalhes sobre o Endless Mode e como experimentá-lo.
...
Veja o **[Guia de Configuração](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/configuration.mdx)** para todas as configurações disponíveis e exemplos.

---

## Desenvolvimento

Veja o **[Guia de Desenvolvimento](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx)** para instruções de build, testes e fluxo de contribuição.
...
Veja o **[Guia de Solução de Problemas](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/troubleshooting.mdx)** para problemas comuns e soluções.
...
Veja [Guia de Desenvolvimento](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx) para o fluxo de contribuição.
...
- **Repositório**: [github.com/vinhvgs/Claude-Memory-Openclaw](https://github.com/vinhvgs/Claude-Memory-Openclaw)
