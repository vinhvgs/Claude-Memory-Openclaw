...
📚 **[查看完整文档](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public)** - 在官方网站浏览

### 入门指南

- **[安装指南](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/installation.mdx)** - 快速开始与高级安装
- **[使用指南](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/getting-started.mdx)** - Claude-Mem 如何自动工作
- **[搜索工具](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/search-tools.mdx)** - 使用自然语言查询项目历史
- **[测试版功能](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/beta-features.mdx)** - 尝试实验性功能,如无尽模式

### 最佳实践

- **[上下文工程](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/context-engineering.mdx)** - AI 代理上下文优化原则
- **[渐进式披露](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/progressive-disclosure.mdx)** - Claude-Mem 上下文启动策略背后的哲学

### 架构

- **[概述](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/overview.mdx)** - 系统组件与数据流
- **[架构演进](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture-evolution.mdx)** - 从 v3 到 v5 的旅程
- **[钩子架构](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/hooks-architecture.mdx)** - Claude-Mem 如何使用生命周期钩子
- **[钩子参考](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/hooks.mdx)** - 7 个钩子脚本详解
- **[Worker 服务](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/worker-service.mdx)** - HTTP API 与 Bun 管理
- **[数据库](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/database.mdx)** - SQLite 模式与 FTS5 搜索
- **[搜索架构](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/search-architecture.mdx)** - 使用 Chroma 向量数据库的混合搜索

### 配置与开发

- **[配置](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/configuration.mdx)** - 环境变量与设置
- **[开发](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx)** - 构建、测试、贡献
- **[故障排除](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/troubleshooting.mdx)** - 常见问题与解决方案
...
详见[架构概述](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/architecture/overview.mdx)。
...
详见[搜索工具指南](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/usage/search-tools.mdx)的详细示例。
...
详见 **[测试版功能文档](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/beta-features.mdx)** 了解无尽模式的详细信息和试用方法。
...
详见 **[配置指南](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/configuration.mdx)** 了解所有可用设置和示例。

---

## 开发

详见 **[开发指南](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx)** 了解构建说明、测试和贡献工作流程。
...
详见 **[故障排除指南](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/troubleshooting.mdx)** 了解常见问题和解决方案。
...
详见[开发指南](https://github.com/vinhvgs/Claude-Memory-Openclaw/tree/main/docs/public/development.mdx)了解贡献工作流程。
...
- **文档**: [docs/](docs/)
- **问题反馈**: [GitHub Issues](https://github.com/vinhvgs/Claude-Memory-Openclaw/issues)
- **仓库**: [github.com/vinhvgs/Claude-Memory-Openclaw](https://github.com/vinhvgs/Claude-Memory-Openclaw)
